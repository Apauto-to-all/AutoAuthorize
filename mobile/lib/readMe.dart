...
（3）如果你连接了校园网，并重新打开我们的程序，在未登入情况下，程序会自动帮你登入校园网，并利用通知告诉你登入情况，完成后自动退出程序。（全自动！！！不过还是需要你在连接校园网后，再运行本程序，做过一个后台监测校园网的功能，但不好用，就删除了，不过即使是我性能渣的手机，打开速度却不慢的。我感觉……用处不大，看你们的反馈吧，毕竟Win端已经做出了监测校园网的功能。）
